...
public class PortfolioService {
	...
	public void buyStock(String symbol, int quantity) throws BalanceException, StockNotExistsException, NegativeBalanceException, StockNotExistException, NegativeQuantityException {
		getPortfolio().buyStock(symbol, quantity);
		flush();
	}

	public void sellStock(String symbol, int quantity) throws StockNotExistsException, IllegalQuantityException, StockNotExistException, NotEnoughQuantityExepction, NegativeQuantityException {
		getPortfolio().sellStock(symbol, quantity);
		flush();
	}

	public void removeStock(String symbol) throws StockNotExistsException, IllegalQuantityException, StockNotExistException, NotEnoughQuantityExepction, NegativeQuantityException {
