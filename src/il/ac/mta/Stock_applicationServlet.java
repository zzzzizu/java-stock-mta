...
public class Stock_applicationServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String line2 = new String("Length of opposite where angle B is " + angleB + " degrees and Hypotenuse length is " + hypotenuse + " cm is: " + opposite+" cm");
		
		double base = 20;
		double exp = 13;
		double result2 = Math.pow(base, exp);
		String line3 = new String("Power of " + base + " with exp of "+ exp + " is " + result2);
